      ...
      <div className="min-h-full">
        ...
        <main>
          <div className="flex flex-col px-8 py-8 m-auto max-w-7xl scroll-auto">
            <Dialog.Root>
              <Dialog.Trigger className="relative self-end w-48 h-12 overflow-hidden text-lg bg-white rounded-lg shadow disabled:cursor-not-allowed group disabled:opacity-50">
