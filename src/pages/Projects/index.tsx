        ...
        <main>
          <div className="flex flex-col px-8 py-8 m-auto max-w-7xl scroll-auto">
            <div className="flex flex-col items-center justify-center gap-6 md:flex-row md:justify-between">
              <ProjectsFilter />
              <button className="relative self-end w-full h-12 overflow-hidden text-lg bg-white rounded-md shadow md:w-48 disabled:cursor-not-allowed group disabled:opacity-50">
